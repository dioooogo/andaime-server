...
                    # Verificar andaimes expirados para notificação
                    if days_expired == 0:
                        mensagem = (
...
            # Esperar 24 horas antes da próxima verificação
...
            now = datetime.now()
            
            # Processar andaimes para calcular dias até expiração
            for andaime in andaimes:
                end_date = datetime.fromisoformat(andaime['estimatedEndDate'].replace('Z', '+00:00'))
